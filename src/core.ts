import { BOOTSTRAP, NOT_MOUNT, NOT_UNMOUNT, UNMOUNT, MOUNT, INDEX } from './helpers';
import { start } from './start';

import { ContexExtension, CanvasExtension } from './extension';

function flattenFnArray(fns, canvas, customProps): any {
...
function createCanvas(width, height): object {
...
// 初始设置
export function settingCanvas(vm): void {
...
// 渲染 and 导出
export function renderCanvas(vm): void {
...
// 销毁
export function destroyCanvas(vm): void {
